...
```javascript
import time from 'https://cdn.jsdelivr.net/gh/stdlib-js/time@v0.4.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { base, constants, currentYear, dayOfQuarter, dayOfYear, daysInMonth, daysInYear, duration2ms, hoursInMonth, hoursInYear, isoWeeksInYear, minutesInMonth, minutesInYear, ms2duration, now, quarterOfYear, secondsInMonth, secondsInYear, tic, toc } from 'https://cdn.jsdelivr.net/gh/stdlib-js/time@v0.4.1-deno/mod.js';
```
