...
```javascript
import time from 'https://cdn.jsdelivr.net/gh/stdlib-js/time@v0.4.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { base, constants, currentYear, dayOfQuarter, dayOfYear, daysInMonth, daysInYear, duration2ms, hoursInMonth, hoursInYear, isoWeeksInYear, minutesInMonth, minutesInYear, ms2duration, now, quarterOfYear, secondsInMonth, secondsInYear, tic, toc } from 'https://cdn.jsdelivr.net/gh/stdlib-js/time@v0.4.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/time/actions/workflows/test.yml/badge.svg?branch=v0.4.1
[test-url]: https://github.com/stdlib-js/time/actions/workflows/test.yml?query=branch:v0.4.1
