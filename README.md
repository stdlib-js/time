...
```javascript
import { constants, dayOfQuarter, dayOfYear, daysInMonth, daysInYear, hoursInMonth, hoursInYear, isoWeeksInYear, minutesInMonth, minutesInYear, now, quarterOfYear, secondsInMonth, secondsInYear, tic, toc } from 'https://cdn.jsdelivr.net/gh/stdlib-js/time@esm/index.mjs';
```
