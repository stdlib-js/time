...
```javascript
import { base, constants, currentYear, dayOfQuarter, dayOfYear, daysInMonth, daysInYear, hoursInMonth, hoursInYear, isoWeeksInYear, minutesInMonth, minutesInYear, now, quarterOfYear, secondsInMonth, secondsInYear, tic, toc } from 'https://cdn.jsdelivr.net/gh/stdlib-js/time@deno/mod.js';
```
